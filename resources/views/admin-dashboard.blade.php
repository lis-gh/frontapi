 ...
 @section('style')
	<!--begin::Page Vendors Styles(used by this page)-->
     <link href="admin-dashboard/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.5" rel="stylesheet" type="text/css" />
 ...
 @section('script')
	...
	<script src="admin-dashboard/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.5"></script>
	<!--end::Page Vendors-->
	<!--begin::Page Scripts(used by this page)-->
	<script src="admin-dashboard/assets/js/pages/widgets.js?v=7.0.5"></script>
	<!--end::Page Scripts-->
